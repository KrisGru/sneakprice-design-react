const Search = () => {
  ...
  return (
    ...
    <div className="container-fluid">
      ...
      <div className="bg col" style={{textAlign: "center", position: "relative", maxWidth: "1350px", height: "320px"}}>
        ...
        <div className="search" style={{width: "100%", maxWidth:"1350px", position:"absolute", height:"250px",bottom: "-125px",}}>
